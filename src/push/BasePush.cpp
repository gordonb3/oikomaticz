					...
					const int metertypein)
{
	...
	try
	{
		...
		else if (vType == "Level")
		{
			...
			int maxDimLevel = 0;
			GetLightStatus(devType, devSubType, static_cast<device::tswitch::type::value>(metertypein), 1, rawsendValue, lstatus, llevel, bHaveDimmer, maxDimLevel, bHaveGroupCmd);
