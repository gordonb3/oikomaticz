...
class XiaomiGateway : public CDomoticzHardwareBase
{
	...
	void InsertUpdateSwitch(const std::string &nodeid, const std::string &Name, bool bIsOn, device::tswitch::type::value switchtype, int unittype, int level, const std::string &messagetype,
