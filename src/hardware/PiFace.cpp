...
void CPiFace::AutoCreate_piface_config(void)
{
	char const * const explanation[] = {
		...
		"//                                  false or 0\r\n",
		"//\r\n",
		"// pin_type:                        level                     // best to keep this parameter to level for outputs, as Oikomaticz does not like other values\r\n",
		"//                                  inv_level\r\n",
		"//                                  rising\r\n",
		"//                                  falling\r\n",
		"//\r\n",
		...
		"// Note2: The initial_value is in counter counts, Oikomaticz scales (divides) this by the factor that is set in the GUI settings \r\n",
		"//\r\n",
#endif
