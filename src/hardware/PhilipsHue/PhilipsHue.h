...
private:
	...
	void InsertUpdateSwitch(int NodeID, uint8_t Unitcode, device::tswitch::type::value SType, bool bIsOn, const std::string& Name, uint8_t BatteryLevel);
...
private:
	...
	// v2 state caches to avoid updating Oikomaticz every poll when nothing changed
