...
private:
	...
	void InsertUpdateSwitch(const int NodeID, const uint8_t Unitcode, const device::tswitch::type::value SType, const bool bIsOn, const std::string &Name, const uint8_t BatteryLevel);
