...
namespace Plugins {
	...
	static PyMethodDef CUnitEx_methods[] = {
		...
		{ "Create", (PyCFunction)CUnitEx_insert, METH_NOARGS, "Create the device in Oikomaticz." },
		{ "Update", (PyCFunction)CUnitEx_update, METH_VARARGS | METH_KEYWORDS, "Update the device values in Oikomaticz." },
		{ "Delete", (PyCFunction)CUnitEx_delete, METH_NOARGS, "Delete the device in Oikomaticz." },
		{ "Touch", (PyCFunction)CUnitEx_touch, METH_NOARGS, "Notify Oikomaticz that device has been seen." },
		{ nullptr } /* Sentinel */
	};
