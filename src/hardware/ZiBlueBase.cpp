...
void CZiBlueBase::GetManualSwitchParameters(const std::multimap<std::string, std::string> &Parameters, device::tswitch::type::value & SwitchTypeInOut, int & LightTypeInOut,
