...
void CDaikin::HTTPSetControlInfo()
{
	 ...
	 * succeeds or fails. Otherwise, in the latter case Oikomaticz elements won't be updated
	 * to reflect the actual state until another command is sent - i.e. if someone requested
	 * the heat pump to be off, but the HTTP request fails, the Oikomaticz switch would show
