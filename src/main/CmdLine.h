...
typedef std::map<std::string, CCmdParam> _CCmdLine;
...
public:
   ...
   /*------------------------------------------------------
      ...
      std::string CCmdLine::GetSafeArgument(const char *pSwitch, int iIdx, const char *pDefault)
   ...
   std::string  GetSafeArgument(const char *pSwitch, int iIdx, const char *pDefault);
