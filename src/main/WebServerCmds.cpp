...
namespace http
{
	namespace server
	{
		...
		static bool ValidateHardware(const hardware::type::value &htype, const std::string &sport, const std::string &address, const int port, const std::string &username, const std::string &password,
									...
									const std::string &extra, const std::string idx = "")
		{
			...
			else if (IsNetworkDevice(htype))
			{
				...
				if ((htype == hardware::type::Domoticz) || (htype == hardware::type::HarmonyHub))
				{
					if (port == 0)
						return false;
				}
				else if ((htype == hardware::type::MySensorsMQTT) || (htype == hardware::type::MQTT) || (htype == hardware::type::MQTTAutoDiscovery))
				{
					if (smode1.empty())
						return false;
				}
			...
			// Below Hardware Types do not have any input checks at the moment
			else if ( (htype == hardware::type::TE923) || (htype == hardware::type::VoltcraftCO20) ||  (htype == hardware::type::OneWire) || (htype == hardware::type::Rtl433) || (htype == hardware::type::Pinger) || (htype == hardware::type::Kodi)
					|| (htype == hardware::type::PanasonicTV) || (htype == hardware::type::LogitechMediaServer) || (htype == hardware::type::RaspberryBMP085) || (htype == hardware::type::RaspberryHTU21D) || (htype == hardware::type::RaspberryTSL2561)
					|| (htype == hardware::type::RaspberryBME280) || (htype == hardware::type::RaspberryMCP23017) || (htype == hardware::type::Dummy) || (htype == hardware::type::Tellstick)
					|| (htype == hardware::type::EVOHOME_SCRIPT) || (htype == hardware::type::EVOHOME_SERIAL) || (htype == hardware::type::EVOHOME_WEB) || (htype == hardware::type::EVOHOME_TCP)
					|| (htype == hardware::type::PiFace) || (htype == hardware::type::HTTPPOLLER) || (htype == hardware::type::BleBox) || (htype == hardware::type::HEOS) || (htype == hardware::type::Yeelight) || (htype == hardware::type::XiaomiGateway)
					...
					|| (htype == hardware::type::OpenWebNetUSB) || (htype == hardware::type::IntergasInComfortLAN2RF) || (htype == hardware::type::EnphaseAPI) || (htype == hardware::type::EcoCompteur) || (htype == hardware::type::Meteorologisk) || (htype == hardware::type::OpenMeteo)
