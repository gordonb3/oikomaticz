...
public:
	...
	bool AddHardwareFromParams(int ID, const std::string &Name, bool Enabled, hardware::type::value Type, const std::string &Address, uint16_t Port, const std::string &SerialPort,
