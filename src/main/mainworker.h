...
private:
	...
	uint8_t get_BateryLevel(const hardware::type::value HwdType, bool bIsInPercentage, uint8_t level);
	...
	void decode_General(const int HwdID, const hardware::type::value HwdType, const tRBUF *pResponse, _tRxMessageProcessingResult & procResult, const uint8_t SignalLevel = 12, const uint8_t BatteryLevel = 255);
