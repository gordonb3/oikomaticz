			...
			switch (djb2hash(cparam.c_str()))
			{
				...
				case "getnotificationtypes"_sh:
				{
					...
					if (dType == pTypeRAIN)
					{
						...
						ii++;
						root["result"][ii]["val"] = notification::type::RAINRATE;
						root["result"][ii]["text"] = notification::type::Description(notification::type::RAINRATE, 0);
						root["result"][ii]["ptag"] = notification::type::Description(notification::type::RAINRATE, 1);
						ii++;
					}
					if (dType == pTypeWIND)
					{
