...
private:
	...
	std::string UpdateSingleState(const uint64_t ulDevID, const std::string &devname, const int nValue, const char* sValue, const unsigned char devType, const unsigned char subType, const device::tswitch::type::value switchType, const std::string &lastUpdate, const unsigned char lastLevel, const std::map<std::string, std::string> & options);
	...
	std::string nValueToWording(const uint8_t dType, const uint8_t dSubType, const device::tswitch::type::value switchtype, const int nValue, const std::string &sValue, const std::map<std::string, std::string> & options);
